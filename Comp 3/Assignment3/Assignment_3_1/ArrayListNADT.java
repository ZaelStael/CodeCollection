...
public interface ArrayListNADT {
    ...
    public boolean isItemAtEqual(int location, int item); // Method to determine whether item is the same as the item in
    ...
    public void replaceAt(int location, int repItem); // Method to replace the element in the list at location with
                                                      // repItem.
