...
public class UnorderedArrayListN extends ArrayListClassN {

    public UnorderedArrayListN() {
        super();
    }

    public UnorderedArrayListN(int size) {
        super(size);
    }
    ...
    public void replaceAt(int l, int location, int repItem) {
