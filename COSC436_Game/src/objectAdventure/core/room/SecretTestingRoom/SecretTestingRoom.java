...
// $Id: SecretTestingRoom.java 720 2024-11-18 20:54:59Z tbaker17 $
...
public final class SecretTestingRoom extends Room implements InputInterceptor, RoomEventListener {
    ...
    public SecretTestingRoom(final int id, String roomName) {
        ...
        super.setRoomDescription("%s\n%s".formatted(
                BASE_DESCRIPTION, INITIAL_DESCRIPTION_AUGMENTATION));
...
//       </code>
     ...
     */
    @Override public String getRoomAuthor() {
     ...
     */
    @Override public void playerLeavingRoom(Player player) {
    ...
    @Override public void playerEnteringRoom(Player player) {
     ...
     */
    @Override public String interceptInput(String inputLine) {
